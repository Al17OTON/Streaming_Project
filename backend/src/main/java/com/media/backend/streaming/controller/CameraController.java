package com.media.backend.streaming.controller;

import com.media.backend.log.LogManager;
import com.media.backend.response_template.BaseResponseTemplate;
import com.media.backend.streaming.request.AuthRequest;
import com.media.backend.streaming.response.AuthResponse;
