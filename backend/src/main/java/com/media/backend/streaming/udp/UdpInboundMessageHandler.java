...
public class UdpInboundMessageHandler {
    ...
    public void handleMessage(Message message, @Headers Map<String, Object> headerMap) throws IOException {
        if(false && !udpFilter.accept(message)) {
